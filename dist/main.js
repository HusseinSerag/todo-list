...
let prot = Object.assign({},Getter , Setter , getList , addToList,remover,identifier)
...
let prot = Object.assign(getter,setter)
    ...
    if(localStorage.hasOwnProperty('projects'))
    {
       ...
       console.log(projects)
        projectsStorage.forEach(project =>{
                Object.setPrototypeOf(project,_projects__WEBPACK_IMPORTED_MODULE_2__.prot)
                ...
                project.toDoList.forEach(todo =>
                    {
                        ...
                        Object.setPrototypeOf(todo,_toDo__WEBPACK_IMPORTED_MODULE_1__.prot)
                        toDoItemFunctionality(project,todoContainer,addToDo,_toDo__WEBPACK_IMPORTED_MODULE_1__.createATodo(todo.getTitle(),todo.getDescription(),new Date(todo.getDueDate()),todo.getPriority()),false)
                    })
...
function createAProject(name,load=true,project){
    if(load)
    {
        project = _projects__WEBPACK_IMPORTED_MODULE_2__.createProject(name);
